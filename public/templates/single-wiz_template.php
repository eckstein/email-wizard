...
get_header();
$postId = get_the_ID();
$wizTemplateObject = get_wiztemplate( $postId );
$wizTemplate = $wizTemplateObject['template_data'];

$current_user = wp_get_current_user();
$userId = $current_user->ID;

$user_folders = get_wizard_user_folders( $userId );

$templateFolder = get_post_meta( $postId, 'user_folder', true );
	...
	<div class="wizHeaderInnerWrap">
		...
		<div class="wizHeader-right">
			<div class="wizHeader-actions">
				...
				<div title="Move Template" class="wizard-button green moveTemplate"
					data-postid="<?php echo $postId; ?>">
...
<div id="single-template-landing" class="entry-content" data-postid="<?php echo $postId; ?>"
		...
		<form id="template-data-form">
			<div class="wizard-form-content">
				...
				$fieldData = [ 
					...
					[ 'id' => 'favorite_fruits', 'label' => 'Favorite Fruits', 'type' => 'checkbox-group',
						'value' => [ 'apple', 'orange' ],
						'options' => [ 
					...
					[ 'id' => 'gender', 'label' => 'Gender', 'type' => 'radio-group',
						'value' => 'female',
						'options' => [ 
					...
					[ 'id' => 'font-family', 'type' => 'select', 'label' => 'Font Family',
						'value' => 'Arial',
						'options' => [ 
